...
/**
 * Raisecom-specific Interface Discovery Module
 * 
 * Extends IF-MIB with Raisecom enterprise OIDs
 * Supports:
 ...
 * - Port-channels
 * 
 * MIBs: IF-MIB, RAISECOM-INTERFACE-MIB
 */
final class RaisecomInterfaceDiscoveryModule implements DiscoveryModuleInterface
{
    // Standard IF-MIB
    ...
    // Raisecom enterprise extensions
    private const RAISECOM_INTERFACE = '1.3.6.1.4.1.8886.1.1';
    ...
    {
        return 'raisecom_interface_discovery';
    }

    public function supports(DiscoveryContext $context): bool
    {
        // Support Raisecom devices
        return strpos($context->sysObjectID(), '1.3.6.1.4.1.8886') === 0;
    }
    ...
    public function discover(DiscoveryContext $context): array
    {
        ...
        try {
            ...
            error_log("Raisecom interface discovery error: " . $e->getMessage());
        }
