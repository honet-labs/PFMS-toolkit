...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .filter-box { background: #fff; border: 1px solid #f0f3f5; border-radius: 8px; padding: 20px; margin-bottom: 25px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); }
        ...
        .btn-apply { background: #004d40; color: #fff !important; border: none; padding: 7px 18px; border-radius: 4px; font-weight: 500; cursor: pointer; height: 34px; display: inline-flex; align-items: center; gap: 6px; transition: 0.2s;}
        .btn-apply:hover { background: #00695c; }
        .btn-reset { background: #fff; color: #4a5568 !important; border: 1px solid #dce1e5; padding: 7px 18px; border-radius: 4px; text-decoration: none; display: inline-flex; align-items: center; height: 34px; font-size: 12px; transition: 0.2s;}
        .btn-reset:hover { background: #f4f6f8; color: #0b1a26 !important; }
        ...
        table.table-pfms thead th { background: #fff !important; border-bottom: 2px solid #e0e4e8 !important; text-transform: uppercase; padding: 12px 15px !important; font-size: 10px !important; color: #94a3b8 !important; font-weight: normal !important; white-space: nowrap; }
        table.table-pfms tbody td { padding: 12px 15px !important; border-bottom: 1px solid #f0f3f5; color: #0b1a26 !important; vertical-align: middle; white-space: nowrap; font-size: 13px; }
        ...
        .agent-link { color: #1976d2 !important; text-decoration: none; font-weight: 600 !important; }
...
<div class="header-box">
    <div>
        <div style="font-size:10px; color:#94a3b8; text-transform:uppercase;"><?= h($full_breadcrumb) ?></div>
...
$(document).ready(function() {
    $('#moduleTable').DataTable({
        ...
        "buttons": [
            { extend: 'csvHtml5', text: '<span class="material-symbols-outlined" style="font-size:16px!important;">download</span> CSV', className: 'btn btn-custom', title: 'Module_Inventory_' + new Date().toISOString().slice(0,10) },
            { extend: 'pdfHtml5', text: '<span class="material-symbols-outlined" style="font-size:16px!important;">picture_as_pdf</span> PDF', className: 'btn btn-custom', orientation: 'landscape', pageSize: 'A4' }
        ]
    });
});
</script>
